...
def init_csv(first_question, mode_label):
    ...
    csv_writer.writerow(['timestamp', 'mode', 'question', 'primary_hex', 'relating_hex', 'changing_lines', 'line_values'])
    csv_file_handle.flush()
    print(f"  Logging to: {filename}\n")

def log_cast(mode_label, question, primary_num, secondary_num, lines):
...
def trigram_name(l1, l2, l3):
    ...
    names = {
        (1,1,1):'Qian', (0,0,0):'Kun',  (1,0,0):'Zhen', (1,1,0):'Xun',
        (0,1,0):'Kan',  (1,0,1):'Li',   (0,0,1):'Gen',  (0,1,1):'Dui',
    }
    return names[y]
...
def do_cast(question=None, mode_label=""):
    ...
    if has_changes:
        ...
        log_cast(mode_label, question, primary_num, secondary_num, lines)
    else:
        print(f"\n  Hexagram {primary_num} is stable. No changing lines.\n")
        log_cast(mode_label, question, primary_num, None, lines)
...
if __name__ == "__main__":
    ...
    if mode == "1":
        print("  Traditional mode. Hold your question in mind as you cast.")
